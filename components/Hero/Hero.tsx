...
export default function Hero({ data }: HeroProps) {
  return (
            <section className="relative isolate overflow-hidden bg-gradient-to-br from-white via-blue-50/50 to-purple-50/50 dark:from-gray-900 dark:via-gray-900 dark:to-gray-900 px-4 py-16 sm:px-4 sm:py-24 lg:px-8 lg:py-32">
              ...
              <div className="mx-auto max-w-4xl text-center">
                <h1 className="text-4xl font-bold tracking-tight bg-gradient-to-r from-primary-600 via-purple-600 to-primary-600 bg-clip-text text-transparent dark:from-primary-400 dark:via-purple-400 dark:to-primary-400 sm:text-6xl">
                  {data.title}
                </h1>
                <p className="mt-6 text-lg leading-8 text-gray-700 dark:text-gray-300 sm:text-xl font-medium">
                  {data.subtitle}
                </p>
