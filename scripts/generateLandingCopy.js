...
function buildPrompts(entry) {
  ...
  const systemPrompt = [
    'You write landing-page copy for shabitools.com, an independent US home & power tools review site for DIY homeowners and tradespeople.',
    'Each landing page introduces an online store or brand program where readers can buy tools and home-improvement gear.',
    'Voice: practical, trustworthy, no hype.',
    'Audience: people shopping for power tools (drills, saws, sanders), hand tools, and workshop equipment.',
    'Always return strict JSON with keys:',
    'headline, subheadline, intro, benefits (array of 4-6 strings), howItWorks (array of 3-4 strings),',
    'faq (array of {q,a}, 4-6 items), ctaLabel, metaTitle (<=60 chars), metaDescription (<=160 chars).',
    'Write in English.',
  ...
  const userPrompt = [
    ...
    'The page is on shabitools.com; keep the tone practical and trustworthy.',
  ].join('\n');
