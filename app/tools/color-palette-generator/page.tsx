...
const schema = {
  ...
  url: 'https://shabitools.com/tools/color-palette-generator',
  featureList: overviewData.features.map((f: any) => f.title),
};

export const metadata: Metadata = {
  title: 'Color Palette Generator - Generate Color Palettes Online | shabitools',
  description: overviewData.description,
  keywords: 'color palette generator, color scheme, color picker, palette generator',
  alternates: {
    canonical: 'https://shabitools.com/tools/color-palette-generator',
  },
  other: {
